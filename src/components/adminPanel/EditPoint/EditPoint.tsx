                ...
                <div className={classes.editPoint__container}>
                    <div className={classes.editPoint__inner}>
                        ...
                        <div className={classes.editPoint__textareaBox}>
                            <label className={classes.editPoint__textareaLabel} htmlFor="name">
                                Наименование организации
                            </label>
                            <TextareaAutosize
                                id="name"
                                className={classes.editPoint__textarea}
                        ...
                        <div className={classes.editPoint__textareaBox}>
                            <label className={classes.editPoint__textareaLabel} htmlFor="website">
                        ...
                        <div className={classes.editPoint__textareaBox}>
                            <label className={classes.editPoint__textareaLabel} htmlFor="address">
                                Адрес
                            </label>
                            <TextareaAutosize
                                id="address"
                        ...
                        <div className={classes.editPoint__textareaBox}>
                            <label className={classes.editPoint__textareaLabel} htmlFor="phone">
                        ...
                        <div className={classes.editPoint__textareaBox}>
                            <label
                                className={classes.editPoint__textareaLabel}
                                htmlFor="work-hours"
                            >
                                Время работы
                            </label>
...
вых: Воскресенье`}
                        ...
                        <div className={classes.editPoint__buttons}>
                            <Button variant="contained" sx={{ mr: '16px' }}>
                                Сохранить
                            </Button>
