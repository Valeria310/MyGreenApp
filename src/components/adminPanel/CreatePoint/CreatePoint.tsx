                ...
                <div className={classes.createPoint__container}>
                    <div className={classes.createPoint__inner}>
                        ...
                        <div className={classes.createPoint__textareaBox}>
                            <label className={classes.createPoint__textareaLabel} htmlFor="name">
                        ...
                        <div className={classes.createPoint__textareaBox}>
                            <label className={classes.createPoint__textareaLabel} htmlFor="website">
                        ...
                        <div className={classes.createPoint__textareaBox}>
                            <label className={classes.createPoint__textareaLabel} htmlFor="address">
                                Адрес
                            </label>
                            <TextareaAutosize
                                id="address"
                        ...
                        <div className={classes.createPoint__textareaBox}>
                            <label className={classes.createPoint__textareaLabel} htmlFor="phone">
